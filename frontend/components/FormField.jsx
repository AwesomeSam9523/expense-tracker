...
const FormField = ({type, icon, value, placeholder, handleChangeText, otherStyles, ...props}) => {
      ...
      <View className="bg-secondary border-1 focus:border-white  p-3 h-20  w-full rounded-3xl items-center flex-row">
        ...
        />
        {
          type === "Password" && (
            ...
            >
              <Image source={!showPassword ? icons.eye : icons.eyeHide} className="w-7 h-7 flex "
